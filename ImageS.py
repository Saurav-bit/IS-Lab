...
class Stegno:
    ...
    art ='''¯\_(ツ)_/¯'''
    art2 = '''
By : Kartik Bhatia,Saurav Sharma,Ishika Goel,Abhay Kansal
'''
    output_image_size = 0
    ...
    def main(self,root):
        ...
        b_encode = Button(f,text="Encode Text",command= lambda :self.frame1_encode(f), padx=14,bg="blue")
    ...
    def frame1_decode(self,f):
        ...
        l2 = Label(d_f2, text='Enter the key')
